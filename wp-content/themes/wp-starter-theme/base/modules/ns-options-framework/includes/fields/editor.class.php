 ...
 *
 * Class NSOF_Field_Editor
 * @since  1.0.0
 */
class NSOF_Field_Editor extends NSOF_Field_Text_Input_Base {
	/**
	...
	protected function get_input_classes() {
		...
		$input_classes[] = 'nsof-input-editor';
	...
	protected function render_field( $value, $instance ) {
		...
		<div class="nsof-wrap-input">
			<textarea type="text" name="<?php echo esc_attr( $this->element_name ) ?>" id="<?php echo esc_attr( $this->element_id ) ?>"
				...
				<?php if( ! empty( $this->readonly ) ) echo 'readonly' ?>><?php echo esc_textarea( $value ) ?>
			</textarea>
		</div>
		<?php
	}
