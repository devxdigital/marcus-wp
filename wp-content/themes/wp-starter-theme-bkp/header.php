            ...
            <div class="row py-1">
                <div class="col-10 d-flex align-items-center">
                    ...
                    <form action="<?php the_permalink(); ?>" method="post" class="row g-2 align-items-center sign-in">
                        ...
                        <p class="col-auto col-form-label text-white text-uppercase fine-print"><?php _e('Client Login'); ?></p>
                        <div class="col-auto">
                        ...
                        <div class="col-auto">
                            <button type="submit" name="sign-in" class="btn btn-sm btn-theme btn-circle"><i class="fas fa-play"></i></button>
                        </div>
                        <?php 
            ...
            <div class="row">
                ...
                <div class="col-9 col-lg-3">
                    <?php if( !empty($GLOBALS['logo_type']) ): ?>
                        <div class="header__logo text-end">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
								<a class="nav-link" href="http://swphdev.com/sandbox/marcus-solomon/ignite-funding/tax-information/">Resource Library</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="#">Available Investments</a>
							</li>
							<li class="nav-item">
								<a class="nav-link" href="http://swphdev.com/sandbox/marcus-solomon/ignite-funding/news-updates/">News & Updates</a>
							</li>
						</ul>
						<?php if ( is_user_logged_in() ) : ?>
                        <div class="d-flex">
